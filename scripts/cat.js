...
var relaxedOrStressed = ( (easyFirst && round == 1) || (!easyFirst && round == 2) ) ? "relaxed" : "stressed";
var congruent = ( (easyFirst && round == 1) || (!easyFirst && round == 2) ) ? true : false;
...
function startGame() {
	...
	var sessionmarker = getCurrentTime();
